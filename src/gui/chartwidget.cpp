...
{
    //std::cout << "ChartWidget::setPly " << ply << "\n";
    m_ply = ply;
    updatePly();
    update();
}
...
#endif
{
    //std::cout << "ChartWidget::enterEvent\n";
...
{
    //std::cout << "ChartWidget::leaveEvent\n";
    unsetCursor();
...
{
    //std::cout << "ChartWidget::updatePly " << m_values.size() << "\n";
...
{
    //std::cout << "ChartWidget::updatePolygon\n";
